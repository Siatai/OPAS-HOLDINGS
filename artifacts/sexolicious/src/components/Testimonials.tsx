...
const testimonials = [
  {
    quote: "I've always wanted exposure to the Dubai real estate market, but the barrier to entry was too high. Opas Holdings let me build a global portfolio in literally 10 minutes. The monthly yields are flawless.",
    name: "Alexander C.",
